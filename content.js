...
(function() {
  ...
  var css = [
    ...
    '#min-btn{background:transparent;border:none;color:#a0b0cc;font-size:16px;line-height:1;cursor:pointer;padding:0 2px;flex-shrink:0;transition:color .2s,transform .2s;}',
    '#min-btn:hover{color:#fff;}',
    '#panel.minimized #min-btn{transform:rotate(180deg);}',
    // Status bar
